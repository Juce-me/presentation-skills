...
- the resulting thought is visually secondary to the evidence it summarizes
...
- if the resulting thought is the payoff, reveal it last as a dominant hero / overlay instead of a footer, caption, subtitle, or bridge line
